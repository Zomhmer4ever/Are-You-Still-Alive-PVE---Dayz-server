class FreePigsMission extends SurvivorMissions
{
	...
	{		
		...
		m_MissionMessage1 = SurvivorName +", a farmer from "+ m_MissionLocation +", died 2 days ago after a attack from bandits. He was protecting his animals from infected and scavengers and was farming pigs to deliver meat to the young and old survivors.";
		m_MissionMessage2 = "He was well known by other survivors for his perfection in making good bacon and spiced meat for barbecue. His pigs are still in the shed and I am afraid they could starve to death, if they are not already dead by infected or robbed by bandits.";
