class CityMallMission extends SurvivorMissions
{
	...
	{		
		...
		m_MissionMessage1 = "Ms. "+ SurvivorName +", a school teacher, told me that she has brought some children of her class to safety from their infected families. I promised that i would help her for getting food and other medical supplies for the kids.";
