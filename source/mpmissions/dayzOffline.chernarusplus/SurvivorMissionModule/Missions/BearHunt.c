class BearHuntMission extends SurvivorMissions
{
	...
	{	
		...
		m_MissionMessage1 = "A survivor recently reported to me that a bear attacked my friend "+ SurvivorName +" and killed 2 other survivors. They went to the wrong location trying to hunt some deer in the forest of "+ m_MissionLocation +".";
		m_MissionMessage2 = "I still can't believe it. "+ SurvivorName +" was one of the best hunters around here. Once a week he brought fresh meat to the hidden camp to feed the survivors. He was selfless and tried to do everything to help out in the camp.";
